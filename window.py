...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/beauty.jpg"))
        # pic reading thread
        self.output_size = 480
        self.img2predict = ""
        self.device = 'cpu'
        # # init video reading thread
        self.vid_source = '0'  # init setting is camera
        self.stopEvent = threading.Event()
        self.webcam = True
        self.stopEvent.clear()
        self.model = self.model_load(weights="runs/train/exp/weights/best.pt",
                                     device=self.device)  # todo modeling
        self.initUI()
        self.reset_vid()
    ...
    ***UI init***
    ...
    def initUI(self):
        ...
        # Image recognition interface, two buttons, upload images and display results
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("Image recognition")
        ...
        up_img_button = QPushButton("Upload picture")
        ...
        self.webcam_detection_btn = QPushButton("Camera real-time monitoring")
        ...
        about_title = QLabel('Welcome to the target detection system\n\n')  # todo 修改欢迎词语
        ...
        self.setTabIcon(0, QIcon('images/UI/beauty.jpg'))
        self.setTabIcon(1, QIcon('images/UI/beauty.jpg'))
        self.setTabIcon(2, QIcon('images/UI/beauty.jpg'))

    '''
    ***upload picture***
    '''
    def upload_img(self):
        # Select video file to read
        fileName, fileType = QFileDialog.getOpenFileName(self, 'Choose file', '', '*.jpg *.png *.tif *.jpeg')
        if fileName:
            suffix = fileName.split(".")[-1]
            save_path = osp.join("images/tmp", "tmp_upload." + suffix)
            shutil.copy(fileName, save_path)
            # should adjust the size of the picture, and then prevent it together
            ...
            # todo After uploading the picture, the picture on the right is reset
            self.right_img.setPixmap(QPixmap("images/UI/result.jpg"))
    ...
    ***Detection picture***
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "Please upload", "Please upload the picture before testing")
        else:
            source = str(source)
    ...
    # The logic of video detection is basically the same. It has two functions: the function of detecting the camera and the function of detecting video files. First, the function of detecting the camera.

    '''
    ### Interface closing event ### 
    '''
    ...
    '''
    ### Open video file detection event ### 
    '''
    ...
    # The main functions of video and camera are the same, but the incoming source is different
    def detect_vid(self):
        # pass
        model = self.model
        output_size = self.output_size
